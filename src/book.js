          ...
          <Content>
            <View style={styles.backgroundImage}>
              ...
              <View style={{width : '100%' , justifyContent : 'center' , alignItems : 'center' , marginBottom : width * 0.05}}>
                <Text style={{fontSize : RFPercentage(2.8) , color : '#FFF' , fontWeight : 'bold' ,  marginTop : width * 0.07 , textAlign : 'center'}}>Book Now!</Text>
              </View>
            </View>
            <View style={{width : '100%' , justifyContent : 'center' , alignItems : 'center'}}>
              <View style={{height : width * 1.1 , backgroundColor : '#FFF' , borderRadius : 40 , flexDirection : 'column' , marginTop : width * -0.29 , width : '90%'}}>
                <View style={{width : '100%' , flexDirection : 'column' , marginTop : width * 0.05}}>
                  <View style={{width : '100%' , height : width * 0.45, borderRadius : 20 , flexDirection : 'column'}}>
                    <View style={{flex : 1 , flexDirection : 'column' , alignItems : 'center' , justifyContent : 'center'}}>
                      <View style={{width : '90%' , alignItems : 'center' , justifyContent : 'center'}}>
                        <Image source={require('./img/booko.png')} style={styles.post} />
                      </View>
                    </View>
                  </View>
                  <View style={{width : '100%' , flexDirection : 'column'}}>
                    <View style={styles.inputPlace}>
                      <View style={{width : '80%'}}>
                        <Text style={{color : '#808080' , fontSize : RFPercentage(1.8) , fontWeight : 'bold' , textAlign : 'left' , marginBottom : width * -0.03}} >Mobile Number</Text>
                      </View>
                      <TextInput
                          placeholder={''}
                    ...
                    <View style={styles.inputPlace}>
                      <View style={{width : '80%'}}>
                        <Text style={{color : '#808080' , fontSize : RFPercentage(1.8) , fontWeight : 'bold' , textAlign : 'left' , marginBottom : width * -0.03}} >Site Url</Text>
                      </View>
                      <TextInput
                          placeholder={''}
                          style={styles.inpNumber}
                    ...
                    <View style={styles.inputPlace}>
                      <View style={{width : '80%'}}>
                        <Text style={{color : '#808080' , fontSize : RFPercentage(1.8) , fontWeight : 'bold' , textAlign : 'left' , marginBottom : width * -0.03}} >Which Service You Need Help?</Text>
                      </View>
                      <TextInput
                          placeholder={''}
                          style={styles.inpNumber}
