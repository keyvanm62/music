          ...
          <Content>
            <View style={styles.backgroundImage}>
              ...
              <View style={{width : '100%' , justifyContent : 'center' , alignItems : 'center' , marginBottom : width * 0.05}}>
                <Text style={{fontSize : RFPercentage(2.8) , color : '#FFF' , fontWeight : 'bold' ,  marginTop : width * 0.07 , textAlign : 'center'}}>Website Development</Text>
              </View>
            </View>
            <View style={{width : '100%' , justifyContent : 'center' , alignItems : 'center'}}>
              <View style={{height : width * 0.7 , backgroundColor : '#FFF' , borderRadius : 40 , flexDirection : 'column' , marginTop : width * -0.29 , width : '90%'}}>
                <View style={{width : '100%' , flexDirection : 'column' , marginTop : width * 0.05}}>
                  ...
                  <View style={{width : '100%' , flexDirection : 'row'}}>
                    <View style={{width : '50%'}}>
                      <Text style={{fontSize : RFPercentage(2) , color : '#000' , fontWeight : 'bold' , marginTop : width * 0.05 , textAlign : 'center'}}>+1000</Text>
                      <Text style={{fontSize : RFPercentage(1.6) , color : '#8f8f8f' , fontWeight : 'bold' , marginTop : width * 0.02 , textAlign : 'center'}}>Websites</Text>
                    </View>
                    <View style={{width : '50%'}}>
                    <Text style={{fontSize : RFPercentage(2) , color : '#000' , fontWeight : 'bold' , marginTop : width * 0.05 , textAlign : 'center'}}>+100</Text>
                    <Text style={{fontSize : RFPercentage(1.6) , color : '#8f8f8f' , fontWeight : 'bold' , marginTop : width * 0.02 , textAlign : 'center'}}>Web Applications</Text>
                    </View>
                  </View>
                </View>
              </View>
              <View style={{width : '90%' , justifyContent : 'center'}}>
                ...
                <Text style={{fontSize : RFPercentage(2) , color : '#757275' , fontWeight : 'bold' , marginTop : width * 0.02 , textAlign : 'justify'}}>{'\u2022'} Frontend technology service</Text>
