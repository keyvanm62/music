          ...
          <Content>
            <View style={styles.backgroundImage}>
              ...
              <View style={{width : '100%' , justifyContent : 'center' , alignItems : 'center' , marginBottom : width * 0.05}}>
                <Text style={{fontSize : RFPercentage(2.8) , color : '#FFF' , fontWeight : 'bold' ,  marginTop : width * 0.07 , textAlign : 'center'}}>My Settings</Text>
              </View>
            </View>
            <View style={{width : '100%' , justifyContent : 'center' , alignItems : 'center'}}>
              <View style={{height : width * 0.9 , backgroundColor : '#FFF' , borderRadius : 40 , flexDirection : 'column' , marginTop : width * -0.29 , width : '90%'}}>
                <View style={{width : '100%' , flexDirection : 'column' , marginTop : width * 0.05}}>
                  ...
                  <View style={{width : '100%' , flexDirection : 'column'}}>
                    <View style={styles.inputPlace}>
                      <View style={{width : '80%'}}>
                        <Text style={{color : '#808080' , fontSize : RFPercentage(1.8) , fontWeight : 'bold' , textAlign : 'left' , marginBottom : width * -0.03}} >Name</Text>
                      </View>
                      <TextInput
                          placeholder={''}
                    ...
                    <View style={styles.inputPlace}>
                      <View style={{width : '80%'}}>
                        <Text style={{color : '#808080' , fontSize : RFPercentage(1.8) , fontWeight : 'bold' , textAlign : 'left' , marginBottom : width * -0.03}} >Mobile</Text>
                      </View>
                      <TextInput
                          placeholder={''}
                          style={styles.inpNumber}
                    ...
                    <View style={styles.inputPlace}>
                      <View style={{width : '80%'}}>
                        <Text style={{color : '#808080' , fontSize : RFPercentage(1.8) , fontWeight : 'bold' , textAlign : 'left' , marginBottom : width * -0.03}} >Website</Text>
                      </View>
                      <TextInput
                          placeholder={''}
                          style={styles.inpNumber}
              ...
              <View style={{width : '90%' , marginTop : width * 0.05}}>
                <TouchableOpacity onPress={() => this.login()} style={{width : '100%' , height : width * 0.14 , backgroundColor : '#7749bd' , borderRadius : 10 , justifyContent : 'center' , alignItems : 'center'}}>
                  <Text style={{color : '#FFF' , fontSize : RFPercentage(2.6) , fontWeight : 'bold'}} >Update</Text>
                </TouchableOpacity>
              </View>
            </View>
          </Content>
