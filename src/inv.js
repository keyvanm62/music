...
export default class Inv extends Component<Props> {
  constructor(Props){
    super(Props);
    this.state ={
      name : '',
          ...
          <Content>
            <View style={styles.backgroundImage}>
              ...
              <View style={{width : '100%' , justifyContent : 'center' , alignItems : 'center' , marginBottom : width * 0.05}}>
                <Text style={{fontSize : RFPercentage(2.8) , color : '#FFF' , fontWeight : 'bold' ,  marginTop : width * 0.07 , textAlign : 'center'}}>Invite Your Friends!</Text>
              </View>
            </View>
            <View style={{width : '100%' , justifyContent : 'center' , alignItems : 'center'}}>
              <View style={{height : width * 0.75 , backgroundColor : '#FFF' , borderRadius : 40 , flexDirection : 'column' , marginTop : width * -0.29 , width : '90%'}}>
              ...
              <View style={{width : '90%' , marginTop : width * 0.05}}>
                <TouchableOpacity onPress={() => this.login()} style={{width : '100%' , height : width * 0.14 , backgroundColor : '#7749bd' , borderRadius : 10 , justifyContent : 'center' , alignItems : 'center'}}>
                  <Text style={{color : '#FFF' , fontSize : RFPercentage(2.6) , fontWeight : 'bold'}} >Send Invitation</Text>
                </TouchableOpacity>
              </View>
            </View>
          </Content>
